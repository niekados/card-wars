...
- Deck Size Indicators: Labels with the name "Deck Size" were added next to the card decks, clearly indicating that these decks were associated with the player and the computer.
